...
var view = function () {
	function view(_view) {
		...
		// 加载图片
		PIXI.loader.add([{ name: "red", url: "images/red@2x.png" }, { name: "green", url: "images/green@2x.png" }, { name: "blue", url: "images/blue@2x.png" }, { name: "yellow", url: "images/yellow@2x.png" }, { name: "purple", url: "images/purple@2x.png" }, { name: "star_red", url: "images/star_red@2x.png" }, { name: "star_green", url: "images/star_green@2x.png" }, { name: "star_blue", url: "images/star_blue@2x.png" }, { name: "star_yellow", url: "images/star_yellow@2x.png" }, { name: "star_purple", url: "images/star_purple@2x.png" }, { name: "pause", url: "images/play@2x.png" }, { name: "play", url: "images/play@2x.png" }, { name: "cover", url: "images/cover.jpg" }]).load(function () {
